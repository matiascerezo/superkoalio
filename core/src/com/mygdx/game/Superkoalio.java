...
public class Superkoalio extends ApplicationAdapter {
    ...
    private void updateKoala(float deltaTime) {
        ...
        if ((Gdx.input.isKeyPressed(Keys.SPACE) || isTouched(0.5f, 1)) && koala.grounded) {
            ...
            Sound salto = Gdx.audio.newSound(Gdx.files.internal("sounds/salto.mp3"));
            salto.play();
        }
        ...
        if (koala.position.y <= 0 && muerte) {
            ...
            Sound sonidoCaer = Gdx.audio.newSound(Gdx.files.internal("sounds/caer.mp3"));
            music.stop();
            sonidoCaer.play();
            muerte = false;
            create();
        ...
        if (koala.position.x >= 347 && muerte) {
            Gdx.app.log("Koala", "Has ganado");
            muerte = false;
            Sound sonidoVictoria = Gdx.audio.newSound(Gdx.files.internal("sounds/victoria.mp3"));
            sonidoVictoria.play();
            music.stop();
            create();
